            ...
            <div className="bg-[] h-auto pb-10">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="flex gap-2">
                        <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-violet-500 hover:bg-violet-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>
                ...
                {/* Hero Section */}
                <div className="bg-[] mt-[30px] relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link to='/app' className="bg-violet-500 hover:bg-violet-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-violet-400 flex items-center transition-colors">
                            Get started
